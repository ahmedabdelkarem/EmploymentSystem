...
namespace Employment.Domain.Migrations
{
    ...
    [Migration("20240512150025_updateAspNetUsers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Employment.Domain.Entities.VacanciesApplication", b =>
                {
                    ...
                    b.HasIndex(new[] { "FkApplicantId" }, "IX_VacanciesApplications_Fk_ApplicantId");

                    b.HasIndex(new[] { "FkVacancyId" }, "IX_VacanciesApplications_Fk_VacancyId");
            ...
            modelBuilder.Entity("Employment.Domain.Entities.VacanciesApplicationsArc", b =>
                {
                    ...
                    b.HasIndex(new[] { "FkApplicantId" }, "IX_VacanciesApplications_ARC_Fk_ApplicantId");
            ...
            modelBuilder.Entity("Employment.Domain.Entities.Vacancy", b =>
                {
                    b.HasOne("Employment.Domain.Entities.AspNetUser", "CreatedByNavigation")
                        .WithMany("Vacancies")
